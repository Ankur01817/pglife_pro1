...
<body>
    ...
    <div class="page-container">
        ...
        <div class="row">
            ...
            <div class="city-card-container col-md">
                <a href="./aagra.php?city=aagra">
                    <div class="city-card rounded-circle">
                        <img src="./img/mosque_7162090.png" class="city-img" alt="aagra" />
                    </div>
                </a>
            </div>
            <div class="city-card-container col-md">
                <a href="./varansi.php?city=Varansi">
                    <div class="city-card rounded-circle">
                        <img src="./img/pngwing.com.png" class="city-img" alt="Varansi"/>
                    </div>
                </a>
            </div>
            <div class="city-card-container col-md">
            ...
            <div class="city-card-container col-md">
                <a href="./jaipur.php? city=Jaipur">
                    <div class="city-card rounded-circle">
                        <img src="./img/hawa-mahal.png" class="city-img" alt="Jaipur" />
                    </div>
                </a>
            </div>
