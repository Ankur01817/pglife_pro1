...
// Check if the booking was successful and display the success message
if (isset($_SESSION['booking_success']) && $_SESSION['booking_success']) {
    echo "Your Booking is successful! Welcome to the PG";
...
?>
    ...
    <div class="property-summary page-container">
        ...
        <div class="row no-gutters">
            ...
            <div class="property-summary page-container">
        <!-- ... (other property summary content) ... -->
        ...
        <form action="booking.php" method="post">
            ...
            <!-- Include other relevant booking form fields here -->
...
<div class="property-testimonials page-container">
    ...
    foreach ($testimonials as $testimonial) {
        ...
        $sql_images = "SELECT image_url FROM testimonial_images WHERE testimonial_id = $testimonial_id";
        $result_images = mysqli_query($conn, $sql_images);
        $testimonial_images = mysqli_fetch_all($result_images, MYSQLI_ASSOC);
    ?>
        <div class="testimonial-block">
            <div class="testimonial-images-container">
                <?php
                foreach ($testimonial_images as $image) {
                ?>
                    <img class="testimonial-img" src="<?= $image['image_url'] ?>">
                <?php
                }
                ?>
            </div>
