...
<head>
    ...
    <title>Best PG's in Varansi | PG Life</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="property-card row">
            <div class="image-container col-md-4">
                <img src="./img/vojtech-bruzek-Yrxr3bsPdS0-unsplash.jpg" />
            </div>
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
                ...
                <div class="detail-container">
                    <div class="property-name">Avantika Hotel</div>
                    <div class="property-address">Near Redison blue, Mohaddipur, Gorakhpur : 273006 UP</div>
                    <div class="property-gender">
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
                    ...
                    <div class="interested-container">
                        <i class="far fa-heart"></i>
                        <div class="interested-text">200+ interested</div>
                    </div>
                </div>
                <div class="detail-container">
